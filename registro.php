    ...
    <body>
        <div class="contenido">
            ...
            <menu>
                ...
                <a href="registro.php"><li class="menu activo" >Registro</li></a>
            ...
            <section style="height:850px">
                ...
                <div class="panel1" >
                    <div class="texto" style="width:90%; margin: auto">
                        <h3 class="tituloCategoria3">Registro:</h3>
                        <br />
                        <p class="p"> El registro de un equipo se confirma una vez recibido el pago de inscripción.</p>
                        <a class="efecto" target="_blank" href="http://www.femexrobotica.org/regtmr/index.php/admin/login"> Ir al sitio de registro </a>
